  ...
  return (
    <nav className='bg-indigo-950 text-white flex justify-between items-center px-4 md:h-14 flex-col md:flex-row'>
      ...
      <div className='relative flex flex-col md:block gap-2 py-2 '>
        ...
        {session &&
          <button type="button" className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center " onClick={() => { signOut() }}>Logout</button>}
